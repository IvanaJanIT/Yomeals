...
//	}
	...
	public void changeProfileTest() throws InterruptedException, IOException {
        ...
        Assert.assertTrue(messageText.contains("Profile Image Uploaded Successfully"), "Message 'Profile Image Uploaded Successfully' is not displayed");
        notificationSistemPage.waitMessageDisappear();
      
        profilePage.imgRemove();
        messageText=notificationSistemPage.getMessageText();
        Assert.assertTrue(messageText.contains("Profile Image Deleted Successfully"), "Message 'Profile Image Deleted Successfully' is not displayed");
        notificationSistemPage.waitMessageDisappear();
